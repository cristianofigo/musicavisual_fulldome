...
Mais detalhes abaixo. (Sincronização com o Navegador)
...
Detalhes da implementação ao final. (Tunel de Renderização)
...
Detalhes logo abaixo(Proposta de Servidor Monolitico)
