...
No contexto desta pesquisa, Fulldome é uma tecnologia para visualização de planetarios virtuais. Existem diversas tecnologias, indo de projetores adaptados e sistemas de multi-projetores, a telas de microled.
...
Sua pecuiliar estrutura resulta em um tambem peculiar tratamento de sua midia. Existem distorções e campos uteis da tela que devem ser bem tratados e considerados durante todas as a fases de produção, para que ocorra um fidedigno mapeamento da projeção a estrutura fisica da tela do domo, garantido a imersão. 
